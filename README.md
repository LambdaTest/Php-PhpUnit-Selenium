...
>**Test Scenario**: Check out the sample [LambdaTest.php](https://github.com/LambdaTest/Php-PhpUnit-Selenium/blob/master/tests/LambdaTest.php) that we used for running a sample test using PHPUnit.
